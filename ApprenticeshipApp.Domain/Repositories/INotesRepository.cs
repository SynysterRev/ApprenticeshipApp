...
namespace ApprenticeshipApp.Domain.Repositories
{
    public interface INotesRepository
    {
        ...
        public Task<List<Note>> GetAllNotesByApprenticeAsync(Guid apprenticeGuid);
        ...
        public Task<List<Note>> GetAllNotesBySessionAsync(Guid sessionGuid);
        ...
        public Task<Note?> GetNoteByGuidAsync(Guid noteId);
        ...
        public Task<Note> AddNoteAsync(Note newNote);
        ...
        public Task<Note?> UpdateNoteAsync(Note updatedNote);
